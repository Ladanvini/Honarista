	...
	public String buy(Customer buyer, Order buyOrder) throws OrderIsDeclinedException, OrderIsQueuedException, UnknownUserIdException, NotEnoughCreditException {
		...
		for(Order sellOrder : sellOrders){
			...
			//if(sellPrice < buyPrice){
				...
				Exchange newEx = new Exchange(symbol, sellOrder.getPrice(), String.valueOf(exPrc), "MPO", sellOrder.getUserId(), buyOrder.getUserId(), exQty, 0, sellOrder.getOid(), buyOrder.getOid(), (new Date()).getTime() );
